...
import numpy as np
import models.joint_resnet1
from tensorboard_logger import configure, log_value
import config

use_cuda = torch.cuda.is_available()
OUTPATH = './checkpoint/checkpoint_joint1'
configure("runs/run-joint1", flush_secs=5)
EPOCH = config.EPOCH
BATCH = config.BATCH
...
#model = Net()
model = models.joint_resnet1.resnet50(num_classes=100)
model.load_state_dict(torch.load("./checkpoint/checkpoint_joint1200"))
